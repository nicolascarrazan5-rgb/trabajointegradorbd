...
namespace Alumno_Materia
{
    public partial class Materias : Form
    {
        ...
        private void agregarMateria()
        {
            ...
            string query = "INSERT INTO materias (nombre, estado, id_carrera) VALUES (@nombre, @estado, @idcarrera)";
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(cadena))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(query, con))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@idcarrera", textBox1.Text.Trim());
        ...
        private void btn_eliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(cadena))
                {
                    ...
                    SqlCommand cmdRel = new SqlCommand(
                        "DELETE FROM alumnos_materias WHERE id_materia = @id", conn);
                    cmdRel.Parameters.AddWithValue("@id", txt_borrar.Text.Trim());
                    cmdRel.ExecuteNonQuery();

                    SqlCommand cmdMat = new SqlCommand(
                        "DELETE FROM materias WHERE id_materia = @id", conn);
                    cmdMat.Parameters.AddWithValue("@id", txt_borrar.Text.Trim());
                    
                    int filas = cmdMat.ExecuteNonQuery();
        ...
        {
            MateriaProfesores materiasprofesores = new MateriaProfesores();
            materiasprofesores.ShowDialog();
        }
        ...
        private void textBox1_Leave_1(object sender, EventArgs e)
        {
            ...
            {
                textBox1.Text = "Ingrese la id carrera...";
        ...
        {
            if (textBox1.Text == "Ingrese la id carrera...")
            {
                textBox1.Text = "";
